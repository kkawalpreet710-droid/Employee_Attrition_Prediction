...
def show():
    ...
    <div style='text-align:center;padding:3rem 1rem 2rem;'>
        ...
        <h1 style='font-size:3.5rem;font-weight:900;line-height:1.05;
            letter-spacing:-2px;text-transform:uppercase;color:#1a1a1a;margin-bottom:1rem;'>
    ...
    metrics = [
        ("1,470", "Employees Analysed", "#ffffff"),
    ...
    st.markdown("""
    <div style='background:#FFD84D;border-radius:20px;padding:3rem 2.5rem;margin-bottom:1.5rem;'>
        <div style='font-size:10px;font-weight:700;letter-spacing:2px;
            text-transform:uppercase;color:#7a6500;margin-bottom:0.5rem;'>
            What you get
        </div>
    ...
    for col, (icon, title, desc) in zip([f1, f2, f3, f4], features):
        with col:
            st.markdown(f"""
            <div style='background:#1a1a1a;border:1px solid #2a2a2a;
                border-radius:14px;padding:1.4rem;min-height:170px;'>
    ...
    <div style='background:#1a1a1a;border-radius:16px;padding:2rem 2.5rem;
        ...
        <div style='font-size:10px;color:#FFD84D;text-transform:uppercase;
            letter-spacing:2px;margin-bottom:0.5rem;font-weight:700;'>
            How it works</div>
        <h3 style='font-size:1.4rem;font-weight:900;text-transform:uppercase;
            color:#ffffff !important;margin-bottom:1.5rem;'>
            THREE STEPS. ZERO GUESSWORK.</h3>
        <div style='display:grid;grid-template-columns:1fr 1fr 1fr;gap:1.5rem;'>
            <div style='border-top:2px solid #FFD84D;padding-top:1rem;'>
                <div style='font-size:11px;color:#FFD84D;font-weight:700;
                    margin-bottom:0.4rem;'>01</div>
                <div style='font-size:13px;font-weight:700;color:#ffffff;
                    text-transform:uppercase;margin-bottom:0.4rem;'>
                    Upload your HR data</div>
                <div style='font-size:11px;color:#aaaaaa;line-height:1.5;'>
                    Drop in your employee CSV or use the sample IBM dataset to explore instantly.</div>
            </div>
            <div style='border-top:2px solid #FFD84D;padding-top:1rem;'>
                <div style='font-size:11px;color:#FFD84D;font-weight:700;
                    margin-bottom:0.4rem;'>02</div>
                <div style='font-size:13px;font-weight:700;color:#ffffff;
                    text-transform:uppercase;margin-bottom:0.4rem;'>
                    Model predicts attrition</div>
                <div style='font-size:11px;color:#aaaaaa;line-height:1.5;'>
                    Logistic Regression scores each employee's risk based on 10+ key factors.</div>
            </div>
            <div style='border-top:2px solid #FFD84D;padding-top:1rem;'>
                <div style='font-size:11px;color:#FFD84D;font-weight:700;
                    margin-bottom:0.4rem;'>03</div>
                <div style='font-size:13px;font-weight:700;color:#ffffff;
                    text-transform:uppercase;margin-bottom:0.4rem;'>
                    HR takes targeted action</div>
                <div style='font-size:11px;color:#aaaaaa;line-height:1.5;'>
                    Download results and prioritise who needs a retention conversation first.</div>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style='text-align:center;padding:2rem;'>
        ...
        <p style='color:#444;font-size:14px;'>
            Use the sidebar to open the Dashboard or start predicting.</p>
    </div>
    """, unsafe_allow_html=True)
