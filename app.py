...
with st.sidebar:
    st.markdown("""
        <div style='padding:0.5rem 0 1.5rem;border-bottom:1px solid #444;margin-bottom:1rem;'>
    ...
    st.markdown("""
        <div style='font-size:11px;color:#888;border-top:1px solid #333;
            padding-top:1rem;margin-top:1.5rem;line-height:1.8;'>
